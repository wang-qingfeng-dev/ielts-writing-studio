...
Keep API keys in environment variables or the ignored .env file. Treat provider responses, sample essays and submitted writing as untrusted content. Do not add credentials, personal drafts or live-result.json to issues or commits.
